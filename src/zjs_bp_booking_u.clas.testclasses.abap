...
CLASS ltcl_handler IMPLEMENTATION.
  ...
  METHOD read_success.
    DATA:
      keys        TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\Booking,
      result      TYPE TABLE FOR READ RESULT zjs_i_travel_u\\Booking,
      result_line TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\Booking,
  ...
  METHOD update_success.
    DATA:
    entities TYPE TABLE FOR UPDATE zjs_i_travel_u\\booking.
  ...
  METHOD rba_travel_success.
    DATA:
      keys                   TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\Booking\_Travel,
      result                 TYPE TABLE FOR READ RESULT zjs_i_travel_u\\Booking\_Travel,
      result_line            TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\Booking\_Travel,
      association_links      TYPE TABLE FOR READ LINK zjs_i_travel_u\\Booking\_Travel,
      association_links_line TYPE STRUCTURE FOR READ LINK zjs_i_travel_u\\Booking\_Travel.
  ...
  METHOD rba_bookingsupplement_success.
    DATA:
      keys                   TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\Booking\_BookSupplement,
      result                 TYPE TABLE FOR READ RESULT zjs_i_travel_u\\Booking\_BookSupplement,
      result_line            TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\Booking\_BookSupplement,
      association_links      TYPE TABLE FOR READ LINK zjs_i_travel_u\\Booking\_BookSupplement,
      association_links_line TYPE STRUCTURE FOR READ LINK zjs_i_travel_u\\Booking\_BookSupplement,
  ...
  METHOD cba_success.
    DATA:
      entities_cba                   TYPE TABLE FOR CREATE zjs_i_travel_u\\Booking\_BookSupplement,
