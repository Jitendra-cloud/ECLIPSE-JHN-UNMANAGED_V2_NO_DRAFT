...
CLASS ltcl_handler IMPLEMENTATION.
  ...
  METHOD read_success.
    DATA:
      result              TYPE TABLE FOR READ RESULT zjs_i_travel_u\\BookingSupplement,
      result_line         TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\BookingSupplement,
  ...
  METHOD update_success.
    DATA:
    entities TYPE TABLE FOR UPDATE zjs_i_travel_u\\BookingSupplement.
  ...
  METHOD rba_travel_success.
    DATA:
      keys                   TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\BookingSupplement\_Travel,
      result                 TYPE TABLE FOR READ RESULT zjs_i_travel_u\\BookingSupplement\_Travel,
      result_line            TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\BookingSupplement\_Travel,
      association_links      TYPE TABLE FOR READ LINK zjs_i_travel_u\\BookingSupplement\_Travel,
      association_links_line TYPE STRUCTURE FOR READ LINK zjs_i_travel_u\\BookingSupplement\_Travel.
  ...
  METHOD rba_booking_success.
    DATA:
      result                 TYPE TABLE FOR READ RESULT zjs_i_travel_u\\BookingSupplement\_Booking,
      result_line            TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\BookingSupplement\_Booking,
      association_links      TYPE TABLE FOR READ LINK zjs_i_travel_u\\BookingSupplement\_Booking,
      association_links_line TYPE STRUCTURE FOR READ LINK zjs_i_travel_u\\BookingSupplement\_Booking,
