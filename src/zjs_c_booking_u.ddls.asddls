...
define view entity ZJS_C_BOOKING_U
  as projection on ZJS_I_BOOKING_U
...
{ ///DMO/I_Booking_U
  ...
  key BookingID,
      ...
      /* Associations */
      ///DMO/I_Booking_U
      _Travel         : redirected to parent ZJS_C_TRAVEL_U,
      _BookSupplement : redirected to composition child ZJS_C_BOOKINGSUPPLEMENT_U,
      _Carrier,
      _Connection,
      _Customer
}
