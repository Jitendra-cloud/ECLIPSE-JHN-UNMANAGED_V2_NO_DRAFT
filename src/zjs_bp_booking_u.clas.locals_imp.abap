...
.
  PRIVATE SECTION.
    ...
    TYPES tt_bookingsupplement_failed TYPE TABLE FOR FAILED zjs_i_bookingsupplement_u.
    TYPES tt_bookingsupplement_reported TYPE TABLE FOR REPORTED zjs_i_bookingsupplement_u.
