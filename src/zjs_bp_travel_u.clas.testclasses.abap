...
RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      mapped             TYPE RESPONSE FOR MAPPED EARLY zjs_i_travel_u,
      failed             TYPE RESPONSE FOR FAILED EARLY zjs_i_travel_u,
      reported           TYPE RESPONSE FOR REPORTED EARLY zjs_i_travel_u,
...
CLASS ltcl_handler IMPLEMENTATION.
  ...
  METHOD create_success.
    DATA:
    entities TYPE TABLE FOR CREATE zjs_i_travel_u\\travel.
  ...
  METHOD update_success.
    DATA:
    entities TYPE TABLE FOR UPDATE zjs_i_travel_u\\travel.
  ...
  METHOD delete_success.
    DATA:
    keys TYPE TABLE FOR DELETE zjs_i_travel_u\\travel.
  ...
  METHOD read_success.
    DATA:
      keys        TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\travel,
      result      TYPE TABLE FOR READ RESULT zjs_i_travel_u\\travel,
      result_line TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\travel.
  ...
  METHOD rba_success.
    DATA:
      keys_rba               TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\travel\_Booking,
      result                 TYPE TABLE FOR READ RESULT zjs_i_travel_u\\travel\_Booking,
      result_line            TYPE STRUCTURE FOR READ RESULT zjs_i_travel_u\\travel\_Booking,
      association_links      TYPE TABLE FOR READ LINK zjs_i_travel_u\\travel\_Booking,
      association_links_line TYPE STRUCTURE FOR READ LINK zjs_i_travel_u\\travel\_Booking,
  ...
  METHOD cba_success.
    DATA:
      entities_cba        TYPE TABLE FOR CREATE zjs_i_travel_u\\travel\_booking,
  ...
  METHOD get_instance_feature.
    ...
    DATA:
      keys               TYPE TABLE FOR INSTANCE FEATURES KEY zjs_i_travel_u\\travel,
      requested_features TYPE STRUCTURE FOR INSTANCE FEATURES REQUEST zjs_i_travel_u\\travel,
      result             TYPE TABLE FOR INSTANCE FEATURES RESULT zjs_i_travel_u\\travel,
      result_line        TYPE STRUCTURE FOR INSTANCE FEATURES RESULT zjs_i_travel_u\\travel,
      import_read        TYPE STRUCTURE FOR READ IMPORT zjs_i_travel_u\\travel,
      import_read_tab    TYPE TABLE FOR READ IMPORT zjs_i_travel_u\\travel,
      result_read        TYPE TABLE FOR READ RESULT zjs_i_travel_u\\travel.
...
* ).
* DATA(env_config) = cl_abap_behv_test_environment=>create_environment_config( )->set_bdef_dependencies( bdef_dependencies = VALUE #( ( 'zjs_i_travel_u' ) ) ).
* DATA(bo_double_environment) = cl_abap_behv_test_environment=>create( environment_config = env_config ).
*
* DATA(bo_double) = bo_double_environment->get_test_double( 'zjs_i_travel_u' ).
*
...
* data(bo_double_input) = bo_double->create_read_input_for_entity( 'zjs_i_travel_u' "can accept the entity name
...
* ENDLOOP.
  ...
  METHOD set_status_booked_success.
    DATA:
      result      TYPE TABLE FOR ACTION RESULT zjs_i_travel_u\\travel~set_status_booked,
      result_line TYPE STRUCTURE FOR ACTION RESULT zjs_i_travel_u\\travel~set_status_booked.
  ...
  METHOD get_global_authorizations.
    DATA:
      requested_authorizations TYPE STRUCTURE FOR GLOBAL AUTHORIZATION REQUEST zjs_i_travel_u\\travel,
      result                   TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT zjs_i_travel_u\\travel.
...
RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      mapped       TYPE RESPONSE FOR MAPPED LATE zjs_i_travel_u,
      failed       TYPE RESPONSE FOR FAILED LATE zjs_i_travel_u,
      reported     TYPE RESPONSE FOR REPORTED LATE zjs_i_travel_u.
